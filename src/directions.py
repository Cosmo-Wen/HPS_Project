...
# 創建 Robot 實例
# TODO: Relocation
robot = Robot(left=(MOTOR_LEFT_PIN1, MOTOR_LEFT_PIN2), right=(MOTOR_RIGHT_PIN1, MOTOR_RIGHT_PIN2))
...
def B():
    move(speed_left=-MOTOR_BASE_SPEED, speed_right=-MOTOR_BASE_SPEED + 0.1)
